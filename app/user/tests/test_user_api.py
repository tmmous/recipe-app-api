...
class PublicUserApiTests(TestCase):
    """Test the users API, public versions"""
    ...
    def test_user_exists(self):
        """Test creating user taht already exists fails"""
        payload = {
    ...
    def test_retreive_user_unauthorized(self):
        """Test that authentication is reqiured for users"""
    ...
    class PrivateUserApiTests(TestCase):
        """Test API requests that require auhentication"""
        ...
        def test_update_user_profile(self):
            ...
            payload = {'name': "New Name", "email": "new@email.com", 'password': 'newpassword123'}
